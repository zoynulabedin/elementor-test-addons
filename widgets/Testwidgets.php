<?php
class Testwidgets extends \Elementor\Widget_Base {
...
public function get_title() {
    return __( 'Test Widget', 'elementor-test-addons' );
}
...
function register_content_controls() {
    $this->start_controls_section(
        'content_section',
        [
            'label' => __( 'Content', 'elementor-test-addons' ),
    ...
    $this->add_control(
        'dummy_text',
        [
            'label'       => __( 'Dummy Text', 'elementor-test-addons' ),
            'type'        => \Elementor\Controls_Manager::TEXTAREA,
            'input_type'  => 'text',
            'placeholder' => __( 'Some Dummy Text', 'elementor-test-addons' ),
            'default'     => __( 'Elementor Test Addons', 'elementor-test-addons' ),
        ]
    );
...
protected function register_style_controls() {
    ...
    $this->start_controls_section(
        'style_section',
        [
            'label' => __( 'Text Style', 'elementor-test-addons' ),
    ...
    $this->add_control(
        'color',
        [
            'label'     => __( 'Color', 'elementor-test-addons' ),
    ...
    $this->add_group_control(
        ...
        [
            ...
            'label'    => __( 'Typography', 'elementor-test-addons' ),
